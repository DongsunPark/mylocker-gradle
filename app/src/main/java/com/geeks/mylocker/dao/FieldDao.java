...
public class FieldDao extends AbstractDao<Field, Long> {
    ...
    */
    ...
    private Query<Field> record_FieldsQuery;
    ...
    public Field readEntity(Cursor cursor, int offset) {
        Field entity = new Field( //
            ...
            cursor.getLong(offset + 4) // recordId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Field entity, int offset) {
        ...
        entity.setRecordId(cursor.getLong(offset + 4));
     }
    ...
    /** Internal query to resolve the "fields" to-many relationship of Record. */
    public List<Field> _queryRecord_Fields(long recordId) {
        synchronized (this) {
            if (record_FieldsQuery == null) {
                ...
                record_FieldsQuery = queryBuilder.build();
            }
        }
        Query<Field> query = record_FieldsQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN RECORD T0 ON T.'RECORD_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected Field loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        Record record = loadCurrentOther(daoSession.getRecordDao(), cursor, offset);
         if(record != null) {
